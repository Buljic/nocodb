...
import * as nc_202607160000_rls_policy_access_level from './v0/nc_202607160000_rls_policy_access_level';
...
export default class XcMigrationSourcev0 {
  ...
  public getMigrations(): Promise<any> {
    ...
    return Promise.resolve([
      ...
      'nc_202607160000_rls_policy_access_level',
    ]);
  }
  ...
  public getMigration(migration): any {
    switch (migration) {
      ...
      case 'nc_202607160000_rls_policy_access_level':
        return nc_202607160000_rls_policy_access_level;
    }
  }
}
